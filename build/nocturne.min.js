(function(_1){
var _2={VERSION:"0.0.10",lesson:"Part 10: Animation",alias:"$n"};
...
nocturne.enumerable.Chainer=function(_58){
this.results=_58;
};
...
(function(){
var _dc={},_dd={},_de,_df,_e0={};
function _e1(_e2){
return _e2.replace(/-+(.)?/g,function(_e3,chr){
...
this.g=0;
this.b=0;
this.value=this.normalise(_e6);
this.parse();
};
_e5.matchers=[{re:/^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/,example:["rgb(123, 234, 45)","rgb(255,234,245)"],process:function(_e7){
return [parseInt(_e7[1]),parseInt(_e7[2]),parseInt(_e7[3])];
}},{re:/^(\w{2})(\w{2})(\w{2})$/,example:["#00ff00","336699"],process:function(_e8){
return [parseInt(_e8[1],16),parseInt(_e8[2],16),parseInt(_e8[3],16)];
}},{re:/^(\w{1})(\w{1})(\w{1})$/,example:["#fb0","f0f"],process:function(_e9){
return [parseInt(_e9[1]+_e9[1],16),parseInt(_e9[2]+_e9[2],16),parseInt(_e9[3]+_e9[3],16)];
}}];
_e5.prototype.normalise=function(_ea){
_ea.replace(/ /g,"");
if(_ea.charAt(0)=="#"){
_ea=_ea.substr(1,6);
}
...
_e5.prototype.parse=function(){
var _eb=[],i;
for(i=0;i<_e5.matchers.length;i++){
_eb=this.value.match(_e5.matchers[i].re);
if(_eb){
_eb=_e5.matchers[i].process(_eb);
this.r=_eb[0];
this.g=_eb[1];
this.b=_eb[2];
break;
...
_e5.prototype.validate=function(){
this.r=(this.r<0||isNaN(this.r))?0:((this.r>255)?255:this.r);
this.g=(this.g<0||isNaN(this.g))?0:((this.g>255)?255:this.g);
this.b=(this.b<0||isNaN(this.b))?0:((this.b>255)?255:this.b);
};
_e5.prototype.sum=function(){
return this.r+this.g+this.b;
};
_e5.prototype.toString=function(){
return "rgb("+this.r+", "+this.g+", "+this.b+")";
};
function _ec(_ed){
return typeof _ed==="string"&&_ed.match(/(#[a-f|A-F|0-9]|rgb)/);
};
function _ee(_ef){
return {value:new _e5(_ef),units:"",transform:_f0};
};
function _f1(_f2,_f3,_f4){
return (_f4(_f3)*_f2.value);
};
function _f0(v,_f5,_f6){
var _f7=[];
_f7[0]=Math.round(v.base.r+(v.direction[0]*(Math.abs(v.base.r-v.value.r)*_f6(_f5))));
_f7[1]=Math.round(v.base.g+(v.direction[1]*(Math.abs(v.base.g-v.value.g)*_f6(_f5))));
_f7[2]=Math.round(v.base.b+(v.direction[2]*(Math.abs(v.base.b-v.value.b)*_f6(_f5))));
return "rgb("+_f7.join(", ")+")";
};
function _f8(_f9){
var n=(typeof _f9==="string")?parseFloat(_f9):_f9,_fa=(typeof _f9==="string")?_f9.replace(n,""):"";
return {value:n,units:_fa,transform:_f1};
};
function _fb(_fc,_fd,_fe){
if(_ec(_fc)){
var _ff=_ee(_fc),i;
_ff.base=new _e5(_fd.style[_fe]);
_ff.direction=[_ff.base.r<_ff.value.r?1:-1,_ff.base.g<_ff.value.g?1:-1,_ff.base.b<_ff.value.b?1:-1];
return _ff;
}else{
return _f8(_fc);
}
...
if(_102=="opacity"&&_df=="filter"){
_101.style[_df]="alpha(opacity="+Math.round(_103*100)+")";
return _101;
}
_101.style[_102]=_103;
return _101;
};
_dd.linear=function(_104){
return _104;
};
_dd.sine=function(_105){
return (-Math.cos(_105*Math.PI)/2)+0.5;
};
_dd.reverse=function(_106){
return 1-_106;
};
_dd.spring=function(_107){
return 1-(Math.cos(_107*Math.PI*4)*Math.exp(-_107*6));
};
_dd.bounce=function(_108){
if(_108<(1/2.75)){
return 7.6*_108*_108;
}else{
if(_108<(2/2.75)){
return 7.6*(_108-=(1.5/2.75))*_108+0.74;
}else{
if(_108<(2.5/2.75)){
return 7.6*(_108-=(2.25/2.75))*_108+0.91;
}else{
return 7.6*(_108-=(2.625/2.75))*_108+0.98;
}
}
}
};
_dc.animate=function(_109,_10a,_10b,_10c){
var _10a=_10a,_10d=(new Date).valueOf(),_10e=_10d+_10a,_10f=_dd.linear,_110;
if(!_df){
_df=_e4();
}
_10c=_10c||{};
if(_10c.hasOwnProperty("easing")){
if(typeof _10c.easing==="string"){
_10f=_dd[_10c.easing];
}else{
if(_10c.easing){
_10f=_10c.easing;
}
...
for(var _111 in _10b){
if(_10b.hasOwnProperty(_111)){
_10b[_111]=_fb(_10b[_111],_109,_111);
if(_111=="opacity"&&_df=="filter"){
_109.style.zoom=1;
}else{
if(_e0.vendorPrefix&&_111=="left"||_111=="top"){
_e0.start(_109,_10a,_111,_10b[_111].value+_10b[_111].units,_10c.easing);
setTimeout(function(){
_e0.end(_109,_111);
},_10a);
return;
...
_110=setInterval(function(){
var time=(new Date).valueOf(),_112=time>_10e?1:(time-_10d)/_10a;
for(var _113 in _10b){
if(_10b.hasOwnProperty(_113)){
_100(_109,_113,_10b[_113].transform(_10b[_113],_112,_10f)+_10b[_113].units);
}
}
if(time>_10e){
clearInterval(_110);
...
_e0={vendors:{"opera":{"prefix":"-o-","detector":function(){
try{
...
var div=document.createElement("div"),_114=false;
...
for(var _115 in _e0.vendors){
_115=this.vendors[_115];
if(_115["detector"]()){
return _115["prefix"];
}
}
},vendorPrefix:null,start:function(_116,_117,_118,_119,_11a){
_116.style[_e1(this.vendorPrefix+"transition")]=_118+" "+_117+"ms "+(_11a||"linear");
_116.style[_118]=_119;
},end:function(_11b,_11c){
_11b.style[_e1(this.vendorPrefix+"transition")]=null;
}};
_e0.vendorPrefix=_e0.findCSS3VendorPrefix();
_dc.fade=function(_11d,_11e,_11f,_120){
_11d.style.opacity=_11f.from;
return _dc.animate(_11d,_11e,{"opacity":_11f.to},{"easing":_11f.easing});
};
_dc.fadeIn=function(_121,_122,_123){
_123=_123||{};
_123.from=_123.from||0;
_123.to=_123.to||1;
return _dc.fade(_121,_122,_123);
};
_dc.fadeOut=function(_124,_125,_126){
var from;
_126=_126||{};
_126.from=_126.from||1;
_126.to=_126.to||0;
from=_126.from;
_126.from=_126.to;
_126.to=from;
_126.easing=function(p){
return (1-p)+_126.from;
};
return _dc.fade(_124,_125,_126,{"easing":_126.easing});
};
_dc.highlight=function(_127,_128,_129){
var _12a=_127.currentStyle?_127.currentStyle:getComputedStyle(_127,null);
_129=_129||{};
_129.from=_129.from||"#ff9";
_129.to=_129.to||_12a.backgroundColor;
_129.easing=_129.easing||_dd.sine;
_128=_128||500;
_127.style.backgroundColor=_129.from;
return setTimeout(function(){
_dc.animate(_127,_128,{"backgroundColor":_129.to,"easing":_129.easing});
},200);
};
_dc.move=function(_12b,_12c,_12d){
return _dc.animate(_12b,_12c,{"left":_12d.x,"top":_12d.y},{"easing":_12d.easing||_dd.sine});
};
_dc.parseColor=function(_12e){
return new _e5(_12e);
};
_dc.pause=function(_12f,_130,_131){
};
_dc.easing=_dd;
_de=function(_132){
this.element=_132;
...
for(methodName in _dc){
(function(_133){
var _133=_dc[methodName];
_de.prototype[methodName]=function(){
var args=Array.prototype.slice.call(arguments);
args.unshift(this.element);
this.position+=args[1]||0;
setTimeout(function(){
_133.apply(null,args);
},this.position);
return this;
};
})(methodName);
}
_dc.chain=function(_134){
return new _de(_134);
};
nocturne.anim=_dc;
})();
